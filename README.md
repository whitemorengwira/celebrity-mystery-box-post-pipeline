# Celebrity Mystery Box — Production Engineering & Workflow Architecture
## DStv · Mzansi Magic · Channel 161 · Film & TV · Client: Brightfire Pictures

![Celebrity Mystery Box Banner](assets/celebrity-mystry-box.webp)
...
In this repository, I present the **production technology, systems thinking, and workflow architecture** behind my work on **Celebrity Mystery Box**, broadcast across **DStv · Mzansi Magic · Channel 161**.
...
* **RESULT**: I delivered high-energy, broadcast-compliant studio masters with vibrant, balanced colour science for DStv Channel 161.
* **CHALLENGE**: I had to handle variable multi-camera lighting in a rapid studio environment with strict episodic delivery milestones.
* **CONTRIBUTION**: I directed the digital intermediate process, executing precision colour correction, match-grading, and broadcast mastering.
* **DELIVERY**: I delivered linear broadcast masters complying with MultiChoice technical guidelines, line-up bars, and loudness standards.
...
├── assets/
│   └── celebrity-mystry-box.webp                 ← Production visual master
├── diagrams/
