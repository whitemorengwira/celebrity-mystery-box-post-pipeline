...
This repository presents the **production technology, systems thinking, and workflow architecture** behind **Celebrity Mystery Box**, broadcast across **DStv · Mzansi Magic · Channel 161**.
...
* **RESULT**: Delivered high-energy, broadcast-compliant studio masters with vibrant, balanced color science for DStv Channel 161.
* **CHALLENGE**: Handling variable multi-camera lighting in a rapid studio environment with strict episodic delivery milestones.
* **CONTRIBUTION**: Directed the digital intermediate process, executing precision colour correction, match-grading, and broadcast mastering.
* **DELIVERY**: Linear broadcast masters complying with MultiChoice technical guidelines, line-up bars, and loudness standards.
